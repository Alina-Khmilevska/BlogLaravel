        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            <a href="/products/create"
                ...
                <div>
                    ...
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Create Product</h2>
            ...
            <a href="/products"
                ...
                <div>
                    ...
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">View All Products</h2>
